...
SOLID_DEF_HEADER_PROPS = 'name input_def_metas output_def_metas description tags positional_inputs required_resource_keys'
...
class SolidDefMeta(namedtuple('_SolidDefMeta', SOLID_DEF_HEADER_PROPS + ' config_field_meta')):
    def __new__(
        cls,
        name,
        input_def_metas,
