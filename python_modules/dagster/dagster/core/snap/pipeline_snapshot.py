...
from .dep_snapshot import DependencyStructureSnapshot, build_dep_structure_snapshot_from_pipeline
...
class PipelineSnapshot(
    ...
    def from_pipeline_def(pipeline_def):
        return PipelineSnapshot(
            ...
            dep_structure_snapshot=build_dep_structure_snapshot_from_pipeline(pipeline_def),
        )
