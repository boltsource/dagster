...
class CompositeSolidDefSnap(namedtuple('_CompositeSolidDefSnap', SOLID_DEF_HEADER_PROPS)):
    def __new__(
        cls,
        name,
        input_def_snaps,
