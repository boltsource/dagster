...
def test_noop_deps_meta():
    ...
    invocations = build_dep_structure_snapshot_from_pipeline(noop_pipeline).solid_invocation_snaps
...
def test_basic_dep_fan_out():
    ...
    dep_structure_snapshot = build_dep_structure_snapshot_from_pipeline(single_dep_pipeline)
    index = DependencyStructureSnapshotIndex(dep_structure_snapshot)
...
def test_basic_fan_in():
    ...
    dep_structure_snapshot = build_dep_structure_snapshot_from_pipeline(fan_in_test)
    index = DependencyStructureSnapshotIndex(dep_structure_snapshot)
